export default {
	...
	services: {
		...
		list: {
			...
			maintenance: {
				...
				bullets: [
					'Замена масла и фильтров — 75–220€',
					'Обслуживание коробки передач — 150–250€',
					'Замена фильтров, свечей и рабочих жидкостей — 75–200€'
				]
			},
			brake: {
				price: 'ОТ 70{euro}',
			...
			custom: {
				...
				bullets: ['Нестандартные ремонты и доработки', 'Индивидуальные проекты', 'Стоимость работ — 75€/час']
			}
		},
		cta: {
	...
	ourService: {
		...
		slides: {
			workshop: {
				title: 'ЗАМЕНА МАСЛА И ФИЛЬТРА — ОТ 75{euro}',
